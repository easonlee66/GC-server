...
//	system("pause");
	...
	freopen("CON","r",stdin);
	if(i==n2-1){
		cout << "ç”¨æˆ·åä¸å­˜åœ¨ï¼Œå¯èƒ½å› ä¸ºæœ¬å¹³å°æš‚æ—¶åªæœ‰ä¸€ä¸ªæœï¼Œè€Œä¸€ä¸ªæœåªèƒ½å®¹çº³50äººï¼Œæ‰€ä»¥è‡ªåŠ¨æ¸…ç†å¤šä½™ä¿¡æ¯\n\n 1.é‡æ–°ç™»å½•   2.é‡æ–°æ³¨å†Œ";
		//system("pause");
		int number;
		number = getch();
		while(number>2){
...
int main(){
	...
	while(number!=0){
		cout << "Ñ¡ÔñÄÄÒ»¿îÓÎÏ·£¿\n  1.²ÂÊý£¨Ô­´´£©  2.Ê¯Í·¼ôµ¶²¼£¨×ªÔØ£©  3.Õü¾È¹«Ö÷£¨Ô­´´£©     4.Ì°³ÔÉß£¨×ªÔØ£©  5.ÃÔ¹¬£¨×ªÔØ£©®«  6.ÉñÓò£¨×ªÔØ£©   7.2048£¨×ªÔØ£©   8.æ–—åœ°ä¸» 0.é€€å‡º\n";
		number=getint4();
		while(number>8){
